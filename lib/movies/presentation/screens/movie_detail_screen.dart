  ...
  Widget build(BuildContext context) {
    return BlocProvider<MovieDetailsBloc>(
      ...
      create: (context) => sl<MovieDetailsBloc>()
        ..add(
          GetMovieDetailsEvent(id: id),
        )
        ..add(
          GetRecommedationsEvent(id: id),
        ),
...
class MovieDetailContent extends StatelessWidget {
          ...
          case RequestState.error:
            {
              return SizedBox(
                child: Center(
                  child: Text(
                    state.movieDetailsMessage.toString(),
                  ),
                ),
              );
            }
  ...
  Widget _showRecommendations(MovieDetailsState state) {
    return SliverGrid(
      //We make it delegate to render it only hwen we scroll to it for better performance.
